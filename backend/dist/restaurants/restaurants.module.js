...
exports.RestaurantsModule = RestaurantsModule = __decorate([
    (0, common_1.Module)({ imports: [typeorm_1.TypeOrmModule.forFeature([entities_1.Restaurant]), auth_module_1.AuthModule], providers: [restaurants_service_1.RestaurantsService], controllers: [restaurants_controller_1.RestaurantsController], exports: [restaurants_service_1.RestaurantsService] })
], RestaurantsModule);
